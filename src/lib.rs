...
//!   for you, define your own structs and implement the `PropertyAccess` trait. The parser can then
//!   write scalars straight into your element type and fill owned list vectors without temporary
//!   `Property` values when your implementation opts in.
